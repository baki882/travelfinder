...
@Component({
    selector: 'jhi-country-tf',
    templateUrl: './country-tf.component.html'
})
export class CountryTfComponent implements OnInit, OnDestroy {
countries: CountryTf[];
    currentAccount: any;
    ...
    trackId(index: number, item: CountryTf) {
        return item.id;
    }
