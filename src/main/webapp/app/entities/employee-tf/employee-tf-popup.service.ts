...
@Injectable()
export class EmployeeTfPopupService {
            ...
            if (id) {
                this.employeeService.find(id)
                    .subscribe((employeeResponse: HttpResponse<EmployeeTf>) => {
                        const employee: EmployeeTf = employeeResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.employeeModalRef(component, new EmployeeTf());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    employeeModalRef(component: Component, employee: EmployeeTf): NgbModalRef {
