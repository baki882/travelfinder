...
import it.bbsoftware.travelfinder.config.audit.AuditEventConverter;
import it.bbsoftware.travelfinder.domain.PersistentAuditEvent;
...
import static it.bbsoftware.travelfinder.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
